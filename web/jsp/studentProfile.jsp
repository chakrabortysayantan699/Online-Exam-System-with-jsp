...
<body>
	...
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			...
			<div class="right-div">
				<a href="index.html" class="btn btn-info pull-right">LOG
					ME OUT</a>
			</div>
		</div>
	</div>
	...
	<div class="content-wrapper">
		<div class="container">
			...
			<div class="row">
				...
				ResultSet resultSet = statement.executeQuery("select * from student where id='"	+ session.getAttribute("uid") + "' and uname='" + session.getAttribute("uname") + "'");
							...
							<form action="" method="">
								...
								<div class="form-group">
									<label>Password.:</label> <input type="password" name="upass"
										class="form-control" value="<%=resultSet.getString(7)%>"readonly>
								</div>
							</form>
							<div class="w3-center">
							<button class="w3-button w3-red w3-round" onclick="location.href='editStudentProfile.jsp'"> Edit Profile</button>

							<button class="w3-button w3-orange w3-round" onclick="location.href='passwordChange.jsp'"> Update Password</button>

							<button class="w3-button w3-cyan w3-round" onclick="location.href='afterStudentLogin.jsp'"> Back</button>
							</div>
						</div>
					</div>
				</div>
