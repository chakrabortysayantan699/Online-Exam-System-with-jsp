...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hover-green">Profile</a>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Exam<b>Qestions</b></h2>
					</div>
					
					<div class="col-sm-6">
						<a onclick="location.href='addQuestion.jsp'" class="btn btn-success" data-toggle="modal"><i class="material-icons">add</i> <span>Add Questions</span></a>
						<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">clear</i> <span>Delete questions</span></a>	
			...
			<table class="w3-table-all w3-hoverable">
				...
				<tbody>
					...
					try{
						...
						session.setAttribute("edit_topic",topic);
						Class.forName("com.mysql.jdbc.Driver");
						Connection con1 =DriverManager.getConnection ("jdbc:mysql://localhost:3306/test","root","papon728**");
						ResultSet allStudentData = con1.createStatement().executeQuery("select * from questions where subjectTopic='"+topic+"'");
				...
				<tr >
					...
					<td><%=allStudentData.getString(6)%></td>
					<td><%=allStudentData.getString(7)%></td> 
					<td><%=allStudentData.getString(8)%></td>
					<td>
					
					<a href="#editEmployeeModal" class="edit" data-toggle="modal" style="color:blue;"><i class="material-icons" data-toggle="tooltip" title="" data-original-title="Edit">edit</i></a>
					<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"style="color:red;"><i class="material-icons" data-toggle="tooltip" title="" data-original-title="Delete">delete</i></a>
		...
		<div class="modal-content">
			<form action="editQuestion.jsp">
				...
				<div class="modal-body">					
					<div class="form-group">
						<label>Exam Id</label>
						<input type="number" name="exam_id" class="form-control"  id="category"  required="">
					</div>
					<!-- <div class="form-group">
						<label>Exam Name</label>
						<input type="text"  name="exam_name"class="form-control" required="">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="Delete_question.jsp">
				...
				<div class="modal-body">
					<div class="form-group">
						<label> Enter Questions Id</label>
						<input type="number" name="Qu_id" class="form-control" required="">
					</div>
