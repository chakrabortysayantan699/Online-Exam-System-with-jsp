...
<body class="">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hover-orange">Accounts</a>
			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons"></i> <span>Delete Student</span></a>						
					</div>
				</div>
			</div>
			<center>
			...
			<table class="w3-table-all w3-hoverable">
				...
				<tbody>
					 <%
					 	...
					 	ResultSet rs1=con1.createStatement().executeQuery("select * from student");
					 	while(rs1.next()){
      %>
					<tr>
						<td>
						...
						<td><b><%=rs1.getInt(1)%></b></td><td><b><%=rs1.getString(2)%></b></td><td><b><%=rs1.getString(3)%></b></td><td><b><%=rs1.getString(4)%></b></td><td><b><%=rs1.getString(5)%></b></td><td><b><%=rs1.getString(6)%></b></td><td><b><%=rs1.getString(7)%></b></td>
						<td>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="register_admin_student.jsp">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="re_pass"  class="form-control" required="">
					</div>														
				</div>
...
<div id="deleteEmployeeModal" class="modal fade" style="display: none;" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="Delete_student.jsp">
				<div class="modal-header">						
				...
				<div class="modal-body">
				  <div class="form-group">
						...
						<input type="number" name="Stud_id" class="form-control" required="">
					</div>
