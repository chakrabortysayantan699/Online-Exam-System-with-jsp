...
<body>
	...
	<div class="content-wrapper">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<form action="insertNewQuestion.jsp" method="post">
						<div class="form-group">
							<b><label>Select Topic:</label></b>
							 <select name="selectTopic"id="mySelect" 
							 class="form-control">
						...
						try {
							...
							ResultSet selectExamTopic = con.createStatement().executeQuery("select topicName from exam_name");
						...
						<div class="form-group">
							<b><label>Question:</label></b> <input type="text" name="question"
						...
						<div class="form-group">
							<b><label>Options-2 </label></b> <input type="text" name="option2"
								class="form-control" required>
						</div>
						<div class="form-group">
							<b><label>Options-3</label></b> <input type="text" name="option3"
								class="form-control" required>
						</div>
						<div class="form-group">
							<b><label>Options-4</label></b> <input type="text" name="option4"
								class="form-control" required>
						</div>
						<div class="form-group">
							<b><label>Correct Answer:</label></b> <input type="text"
								name="correctAnswer" class="form-control" required>
						</div>
